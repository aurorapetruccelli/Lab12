...
class View:
    ...
    def load_interface(self):
        ...
        self.pulsante_conta_archi = ft.ElevatedButton("Conta Archi", width=200,
                                                 on_click=self.controller.handle_conta_archi if self.controller else None,disabled=True)
        ...
        self.pulsante_cammino_minimo = ft.ElevatedButton("Cammino Minimo", width=200,
                                                         on_click = self.controller.handle_cammino_minimo if self.controller else None,disabled=True)
